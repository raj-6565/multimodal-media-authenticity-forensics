...
st.title("🛡️ Multimodal Media Authenticity & Forensic Dashboard")
...
if uploaded_video and run_analysis:
    ...
    with tabs[1]:
        ...
        if audio_result.get("audio_available"):
            ...
            audio_summary = 0.0
            st.warning("No audio track detected in this video. Audio modality excluded from fusion analysis.")
            ...
            if os.path.exists(model_path):
                ...
                **Metadata Forensics**
                ...
                if hasattr(model, "feature_importances_"):
                    ...
                    feature_names = [
                        "Visual Mean", "Visual Variance", 
                        "Suspicious Ratio", "Audio Score", "Metadata Score"
                    ]
                ...
                st.warning("Fusion model (fusion_model.pkl) not found.")
        else:
